...
public class JClient extends JChatComm{
	...
	public void callServer() throws IOException {
		try {
			...
			JPacket outJPacket = new JPacket("Free for a chat?");
			JPacket inJPacket;
			
			outputStream.writeObject(outJPacket);
			System.out.println("Me: Free for a chat?");
			...
			try {
				...
				if(!inJPacket.messageString.equals("Sure. Let us begin.")) {
					System.out.println("Expected reply \"Sure. Let us begin.\". So Go back. Chat later. "); //to be removed
