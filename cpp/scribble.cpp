#include<simplecpp>
/*
Example of how to handle mouse events and key press events in
simplecpp.  Three kinds of events are allowed.

(a) Mouse drag event: some mouse button is pressed and mouse
is moved.  Periodically the mouse raises events which are sent to your program.

(b) Mouse button press: you can know which button was pressed, and where the 
mouse was on the screen at that time.

(c) Pressing of a key.  You can know which key was pressed.  Also where 
the mouse was.
*/
int main(){
