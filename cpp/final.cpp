...
void home(){
	...
	while(true){
		...
		//if(ptx<910&&ptx>390&&pty>210&&pty<303.333) closeCanvas(); game();
		if(ptx<910&&ptx>390&&pty>303.333&&pty<396.666) help();
		if(ptx<910&&ptx>390&&pty>396.666&&pty<490) cout<<"anuradha love you";
	}
}
